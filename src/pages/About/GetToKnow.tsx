                    ...
                    <div className="space-y-8">
                        <main className="container mx-auto px-4 py-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <Card className="">
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <p className="text-gray-700 mt-4">Party's symbol MIKE symbolizes the party's commitment to open communication, transparency, and the free exchange of ideas, highlighting their desire to stay connected with the public.</p>
                                    </CardContent>
                                </Card>
                            ...
                            <Card className="mt-8 ">
                                ...
                                <CardContent className="p-6">
                                    <p className="text-gray-700">We are committed to shaping a brighter future for all. By prioritizing unity, sustainability, and social equity, we aim to build a society where everyone has equal opportunities for growth. We believe in community engagement and transparent governance.</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="mt-8 shadow-lg">
                                ...
                                <CardContent className="p-6">
                                    <div className="flex space-x-4">
                                        <Button
                                            variant={selectedTab === "youth" ? "default" : "secondary"}
                                            onClick={() => setSelectedTab("youth")}
                                        >
                                            Youth
                                        </Button>
                                        <Button
                                            variant={selectedTab === "economic-growth" ? "default" : "secondary"}
                                            onClick={() => setSelectedTab("economic-growth")}
                                        >
                                            Economic Growth
                                        </Button>
                                        <Button
                                            variant={selectedTab === "social-justice" ? "default" : "secondary"}
                            ...
                            <Card className="mt-8 ">
                                ...
                                <CardContent className="p-6">
                                    <p className="mb-4 text-gray-700">Join Our Team: We are always looking for educated and passionate individuals who share our commitment to change. Whether you're a professional, business holder, mentor or expert, we have opportunities for you to make a meaningful impact.</p>
                                    <p className="mb-4 text-gray-700">Volunteer Positions: Support our work and help shape the future by volunteering your time and skills. Whether it's managing or assisting in local initiatives, we welcome your contribution.</p>
                                    <Button className="bg-[#e85a32] hover:bg-[#e85a32] text-white px-6 py-2 rounded-full" onClick={() => navigate('/auth/signup')}>Join Now</Button>
                                </CardContent>
                            </Card>
                        </main>
                    </div>
