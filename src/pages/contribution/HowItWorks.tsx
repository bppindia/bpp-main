      ...
      <section className='container py-8'>
        <div className='container mx-auto max-w-7xl px-4'>
          ...
          <div className='my-12 grid gap-8 md:grid-cols-2'>
            <div>
              <div>
                <h2 className='mb-4 text-xl font-extrabold tracking-tight dark:text-white lg:text-2xl'>
                  Register your Case
                </h2>
                <p className='text-md mb-6 mt-3 text-gray-600 dark:text-gray-400'>
                  Every member of the community, or the primary member who has
                  any concern to address can upload that on the App.
                </p>
              ...
              <div className='mt-8 space-y-3'>
                ...
                <p className='text-md mb-6 mt-3 text-gray-600 dark:text-gray-400'>
                  The concern will be addresses and review by the Bharatiya
                  Popular Party administration, that consist off State heads,
                  district heads and rural, or block heads. Administration will
                  assess and accept or reject the case on the basis of urgency,
          ...
          <div className='mb-12 grid items-center gap-8 md:grid-cols-2'>
            <div className='space-y-6'>
              ...
              <p className='text-md mb-6 mt-3 text-gray-600 dark:text-gray-400'>
                Submitted concern will go through the verification process. If
