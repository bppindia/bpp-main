...
const MultiStepForm = () => {
  ...
  return (
    <section className="flex justify-center items-center px-4 py-6 min-h-screen sm:p-8 md:p-10 bg-background">
      <div className="w-full max-w-xl">
        ...
        <div className="flex gap-1 justify-center mt-3 text-sm">
