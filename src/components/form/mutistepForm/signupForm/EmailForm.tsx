      ...
      <div className="flex flex-row items-center space-x-3 space-y-0">
        ...
        <div className="leading-none">
          <Label className="text-sm">
            ...
            <span className="underline cursor-pointer text-blue-600" onClick={handleTermsClick}>
              Terms & Conditions
            </span>{" "}
      ...
      <div className="flex flex-row items-center space-x-3 space-y-0">
        ...
        <div className="leading-none">
          <Label className="text-sm">
            ...
            <Link to="/about/bpp-goals" target="_blank" className="underline cursor-pointer text-blue-600">
              Party's Objectives.
            </Link>
          </Label>
        </div>
