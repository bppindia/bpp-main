...
export function AreaChartComponent({ dashboardData, isLoading }: AreaChartProps) {
  if (isLoading) {
    return (
      <Card className="col-span-1">
        <CardHeader>
          <CardTitle>Membership Trends</CardTitle>
          <CardDescription>Cumulative growth of primary and active members</CardDescription>
        </CardHeader>
        <CardContent>
