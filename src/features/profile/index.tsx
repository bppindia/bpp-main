...
const updateProfile = async (_data: ProfileFormValues): Promise<void> => {
  await new Promise(resolve => setTimeout(resolve, 1000));
};
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            You can manage verified emails in <Link to="/dashboard/settings/notifications" className="text-blue-600 hover:underline">email settings</Link>.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
