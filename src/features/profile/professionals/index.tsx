...
const professionalProfileSchema = z.object({
  ...
  profession: z.enum(['medical', 'lawyer', 'engineer', 'social-worker'], {
  ...
  currentExpertise: z
    .string()
    .min(2, { message: 'Current expertise must be at least 2 characters.' }),
  education: z
    .string()
    .min(2, { message: 'Education must be at least 2 characters.' }),
  university: z
    .string()
    .min(2, { message: 'University must be at least 2 characters.' }),
  degree: z
    .string()
    .min(2, { message: 'Degree must be at least 2 characters.' }),
  passoutYear: z
    .number()
    .min(1900, { message: 'Passout year must be after 1900.' })
    .max(new Date().getFullYear()),
  quality: z
    .string()
    .min(2, { message: 'Quality must be at least 2 characters.' }),
  linkedin: z
    .string()
  ...
  skills: z
    .string()
    .min(4, { message: 'Skills must be at least 4 characters.' })
    .max(500),
  references: z
    .string()
    .min(4, { message: 'References must be at least 4 characters.' })
    .max(500),
...
const fetchProfessionalProfile =
  async (): Promise<ProfessionalProfileValues> => {
...
const updateProfessionalProfile = async (
  _data: ProfessionalProfileValues
): Promise<void> => {
  await new Promise((resolve) => setTimeout(resolve, 1000))
}
          ...
          <div className='mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center'>
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Manage your professional information for the political party.
              </p>
            </div>
            <Button
              type='submit'
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              {...field}
                              placeholder="E.g., Doctorate, Bachelor's"
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
