...
export default function Referral() {
    ...
    const [referrals] = useState([
        { name: "John Doe", date: "2 days ago", status: "Joined", membershipNo: "BPP-2025-001", membershipType: "Life Member" },
        { name: "Jane Appleseed", date: "1 week ago", status: "Pending", membershipNo: "Pending", membershipType: "Annual Member" },
        { name: "Sarah Miller", date: "3 weeks ago", status: "Joined", membershipNo: "BPP-2025-010", membershipType: "Life Member" },
        { name: "Sarah Miller", date: "3 weeks ago", status: "Joined", membershipNo: "BPP-2025-010", membershipType: "Life Member" },
        { name: "Sarah Miller", date: "3 weeks ago", status: "Joined", membershipNo: "BPP-2025-010", membershipType: "Life Member" },
    ]);
            ...
            <Main>
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col gap-4 justify-between md:flex-row md:items-center">
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">Refer and Strengthen</h1>
                            <p className="text-sm text-muted-foreground">Invite supporters to join Bharatiya Popular Party.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex gap-2 items-center">
                                    <div className="flex-1 p-2 truncate rounded-md bg-muted">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                {[
                                    { label: "Total Referrals", value: earnings.total, sub: "All-time" },
                                    { label: "Pending Approvals", value: earnings.pending, sub: "Awaiting" },
                                    { label: "Active Members", value: earnings.paid, sub: "Confirmed" },
                                ].map((stat, index) => (
                                    <div key={index} className="flex justify-between items-center">
                                        <div>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                            {[
                                { icon: UserPlusIcon, title: "Invite Supporters", desc: "Share your unique referral link." },
                                { icon: UsersIcon, title: "Build Community", desc: "Each member strengthens our party." },
                                { icon: AwardIcon, title: "Earn Recognition", desc: "Top recruiters may receive honors." },
                            ].map((item, index) => (
                                <Card key={index}>
                                    <CardContent className="flex flex-col items-center p-4 text-center">
                                        <item.icon className="mb-2 w-8 h-8 text-primary" />
