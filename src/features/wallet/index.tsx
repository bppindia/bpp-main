          ...
          <div className='w-full'>
            ...
            <div className='mb-6 grid grid-cols-1 gap-6 md:grid-cols-2'>
              <Card>
                ...
                <CardContent className='flex items-center justify-between'>
                  <div className='text-4xl font-bold'>
                    Rs {walletData.currentBalance.toLocaleString()}
                  </div>
                  <div className='flex gap-3'>
                    <Button
                      onClick={() =>
                        navigate({ to: '/dashboard/wallet/add-fund' })
                      }
                      variant='outline'
                      size='sm'
                    >
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-4xl font-bold'>
                    Rs {walletData.totalAmountRaised.toLocaleString()}
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className='mt-6 grid grid-cols-1 gap-6 md:grid-cols-2'>
              ...
              <Card>
                ...
                <CardContent className='flex flex-col gap-2'>
                  <Button
                    variant='outline'
                    onClick={() => navigate({ to: '/dashboard/donate' })}
                  >
                  ...
                  <Button
                    variant='outline'
                    onClick={() =>
                      navigate({ to: '/dashboard/wallet/transactions' })
                    }
                  >
