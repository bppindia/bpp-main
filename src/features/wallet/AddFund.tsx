    ...
    <>
      ...
      <Main>
        <div className='flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6'>
          ...
          <Card className='dashed rounded-lg border border-dashed border-gray-200 dark:border-gray-800'>
            <CardContent className='flex flex-col items-center gap-2 p-6'>
              ...
              <CardDescription className='text-center'>
                Secure payment with your Visa, Mastercard, or American Express
                card.
              </CardDescription>
            </CardContent>
            ...
            <CardContent>
              <div className='grid gap-4 p-6'>
                <div>
                  ...
                  <CardDescription>
                    Add a new payment method or select an existing one.
                  </CardDescription>
